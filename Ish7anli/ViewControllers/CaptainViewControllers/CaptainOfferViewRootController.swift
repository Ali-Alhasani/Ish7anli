...
class CaptainOfferViewRootController: ButtonBarPagerTabStripViewController {
    ...
    override public func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let child_1 = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CaptainOffer") as! CaptainOfferViewController
        child_1.load()
        // let child_2 = NewOrder22ViewController()
        let child_2 = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CaptainOffer2") as! CaptainOfferViewController2
        child_2.load()
        // child_2.load()
