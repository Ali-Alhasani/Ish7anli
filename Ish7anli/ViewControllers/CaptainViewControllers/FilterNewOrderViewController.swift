//
//  FilterNewOrderViewController.swift
//  Ish7anli
//
...
class FilterNewOrderViewController: UIViewController,UITextFieldDelegate,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    @IBAction func filterAction(_ sender: Any) {
        ...
        DataClient.shared.orderFilter(success: {
            MBProgressHUD.hide(for: self.view, animated: true)
            self.performSegue(withIdentifier: "FilterOrderDetails", sender: self)
        }, failuer: { (_ error) in
            MBProgressHUD.hide(for: self.view, animated: true)
